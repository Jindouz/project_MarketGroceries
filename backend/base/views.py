...
def password_reset_request(request):
    ...
    # reset_url = f"https://rct-supermarket.netlify.app/resetconfirm/{user.id}/{token}" #production
    reset_url = f"http://localhost:3000/resetconfirm/{user.id}/{token}" #development
    send_mail(
        'Password Reset',
